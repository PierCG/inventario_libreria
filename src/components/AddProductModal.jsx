...
export default function AddProductModal({
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      // Validación de código único antes del INSERT.
      ...
      if (existing) {
        onMessage("error", "Ya existe un producto con ese código.");
        return;
      }
      ...
      onMessage("error", error.message || "No se pudo agregar el producto.");
    } finally {
      setSaving(false);
    }
  };
